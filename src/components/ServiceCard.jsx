...
export default function ServiceCard({ service, index }) {
  ...
  return (
    <motion.div
      ...
      <div className={`pointer-events-none blur-2xl rounded-full bg-linear-to-r from-blue-500 via-indigo-500 to-purple-500 w-75 h-75 absolute z-0 transition-opacity duration-500 ${visible ? 'opacity-70' : 'opacity-0'}mix-blend-normal dark:mix-blend-lighten`} style={{ top: position.y - 150, left: position.x - 150 }} />
